...
-- Procedures
--
CREATE DEFINER=`` PROCEDURE `GenerateUniqueReferralCode` (OUT `new_referral_code` VARCHAR(255))   BEGIN
    DECLARE done INT DEFAULT 0;

    REPEAT
        -- Generate a random referral code (6-character alphanumeric)
        ...
        IF NOT EXISTS (SELECT 1 FROM user_details WHERE referral_code = new_referral_code) THEN
            SET done = 1;
        END IF;
...
CREATE DEFINER=`` PROCEDURE `GenerateUniqueUserId` (OUT `new_user_id` VARCHAR(255))   BEGIN
    DECLARE done INT DEFAULT 0;
    ...
    REPEAT
        ...
        IF NOT EXISTS (SELECT 1 FROM user_details WHERE user_id = new_user_id) THEN
            SET done = 1;
        END IF;
    UNTIL done END REPEAT;
END$$
...
(46, 'dda1a440d0e5463b', 'order_Q9JJ4ZQJYdvqiy', 10000.00, 'INR', 'receipt#1', 'paid', '2025-03-21 04:35:05'),
(47, 'dda1a440d0e5463b', 'order_Q9KpU9vG32IybL', 10000.00, 'INR', 'receipt#1', 'paid', '2025-03-21 06:04:27'),
(48, 'a1b2c3d4e5f67890', 'order_Q9Lo3lcrOO3S3R', 100000.00, 'INR', 'receipt#1', 'paid', '2025-03-21 07:01:48');
...
('a1b2c3d4e5f67890', 'user1@test.com', 'user_one', 'user_one', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSTtYlMT_y-EHdA3AHXBo3PNPDApVNmmbAKSQ&shttps://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSTtYlMT_y-EHdA3AHXBo3PNPDApVNmmbAKSQ&s', 10, 0, 'acb123', NULL, 'true'),
...
('c3d4e5f678901ab2', 'user3@test.com', 'user_three', 'user_three', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSTtYlMT_y-EHdA3AHXBo3PNPDApVNmmbAKSQ&shttps://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSTtYlMT_y-EHdA3AHXBo3PNPDApVNmmbAKSQ&s', 0, 0, 'ele123', NULL, 'true'),
('d4e5f678901ab2c3', 'user4@test.com', 'user_four', 'user_four', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSTtYlMT_y-EHdA3AHXBo3PNPDApVNmmbAKSQ&shttps://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSTtYlMT_y-EHdA3AHXBo3PNPDApVNmmbAKSQ&s', 0, 0, 'usr123', NULL, 'true'),
('dda1a440d0e5463b', 'test@123', 'vignesh', 'test123', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSTtYlMT_y-EHdA3AHXBo3PNPDApVNmmbAKSQ&shttps://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSTtYlMT_y-EHdA3AHXBo3PNPDApVNmmbAKSQ&s', 10, 0, 'vig123', NULL, 'true'),
('e5f678901ab2c3d4', 'user5@test.com', 'user_five', 'user_five', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSTtYlMT_y-EHdA3AHXBo3PNPDApVNmmbAKSQ&shttps://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSTtYlMT_y-EHdA3AHXBo3PNPDApVNmmbAKSQ&s', 0, 0, 'lik123', NULL, 'true');
...
--
ALTER TABLE `deliveries`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35258;

--
-- AUTO_INCREMENT for table `live_match_data`
--
ALTER TABLE `live_match_data`
  MODIFY `s_no` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=186;
...
--
ALTER TABLE `overs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5785;

--
-- AUTO_INCREMENT for table `registered_contest`
--
ALTER TABLE `registered_contest`
  MODIFY `s_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=155;
...
--
ALTER TABLE `user_over_data`
  MODIFY `s_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=110;
